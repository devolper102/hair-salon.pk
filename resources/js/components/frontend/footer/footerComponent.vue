		...
		<div class="row gold-border">
	        <div class="col-lg-5 col-12">
                <div class="logo mt-4 mb-lg-4">
                    ...
                    <div class="media-icons mt-4 mb-3">
	        ...
	        <div class="col-lg-7 col-12 mt-5">
	    	    <ul class="about-contact-section w-100 d-inline-block mb-lg-5">
	    	    	<li class="d-inline-block pr-lg-4 text-size-14 font-weight-bold">
	    	    ...
	    	    <div class="android-ios float-right mt-lg-4">
	    	    	<a href="javascript:void(0)"><img src="images/ios.svg" class="d-inline-block"></a>
	    	        <a href="javascript:void(0)"><img src="images/android.svg" class="d-inline-block mt-lg-0 mt-4"></a>
	    	    </div>	
	        </div>
	    </div>
	    <div class="text-center text-white pt-3 pb-1">
	    	<p class="text-size-14">Copyright2020</p>
	    </div>    	
		</div>	
		</footer>	
	</div>
